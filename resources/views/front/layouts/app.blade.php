    ...
    <header class="bg-dark">
        <div class="container">
            <nav class="navbar navbar-expand-xl" id="navbar">
                <a href="{{ route('front.index') }}" class="text-decoration-none mobile-logo">
                        ...
                        @if (count(getCategories()) > 0)
                            @foreach (getCategories() as $category)
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    @if (count($category->sub_category) > 1)
    ...
    <footer class="bg-dark mt-5">
        <div class="container pb-5 pt-3">
            <div class="row">
                ...
                @if (count(pageStatic())>0)
                <div class="col-md-4">
                    <div class="footer-card">
                        <h3>Important Links</h3>
                        <ul>
                            @foreach (pageStatic() as $page)
                                <li><a href="{{ route('fornt.page',$page->slug) }}" title="{{ $page->name }}">{{ $page->name }}</a></li>
                            @endforeach
