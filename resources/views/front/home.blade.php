                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            ...
                            <a class="btn btn-outline-light py-2 px-4 mt-3" href="{{ route('front.cart') }}">Shop Now</a>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach (getCategories() as $category)
                        <div class="col-lg-3">
                            <div class="cat-card">
                                <div class="left">
                                    @if ($category->image != '')
                                        <img src="{{ asset('uploads/category/thumbnail/' . $category->image) }}"
                                            alt="" class="img-fluid">
                                    @else
                        ...
                        <div class="col-md-3">
                            <div class="card product-card">
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link"
                                        href="{{ route('front.product', $featuredProduct->slug) }}">{{ $featuredProduct->title }}</a>
                    ...
                    @foreach ($latestProducts as $latestProduct)
                        ...
                        <div class="col-md-3">
                            <div class="card product-card">
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link"
                                        href="{{ route('front.product', $latestProduct->slug) }}">{{ $latestProduct->title }}</a>
                                    <div class="price mt-2">
