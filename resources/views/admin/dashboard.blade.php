        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-6">
                    <div class="small-box card">
                        <div class="inner">
                            <h3>{{ number_format($saleThisMonth) }}</h3>
                ...
                <div class="col-lg-4 col-6">
                    <div class="small-box card">
                        <div class="inner">
                            <h3>{{ number_format($saleLastMonth) }}</h3>
                            <p>Total Sale Last Month ({{ $lastMontName }})</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-person-add"></i>
                        </div>
                ...
                <div class="col-lg-4 col-6">
                    <div class="small-box card">
                        <div class="inner">
                            <h3>{{ number_format($lastThiryDaysSale) }}</h3>
